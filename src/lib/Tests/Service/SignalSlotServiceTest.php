...
class SignalSlotServiceTest
{
    ...
    public function testUpdateContent()
    {
        ...
        $notifier->updateContent(self::CONTENT_ID, null);
    }
    ...
    private function getCredentials(): void
    {
        ...
        $this->credentialsMock
            ->expects($this->any())
            ->method('getServerUri')
            ->willReturn(self::SERVER_URI);

        $this->credentialsMock
            ->expects($this->any())
            ->method('getApiEndpoint')
            ->willReturn(self::API_ENDPOINT);
    }
    ...
    private function getServicesWithExpectationsForContentModification()
    {
        ...
        return [$repositoryServiceMock, $contentServiceMock];
    }
